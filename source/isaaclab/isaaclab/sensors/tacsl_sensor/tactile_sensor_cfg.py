...
class TactileSensorCfg(SensorBaseCfg):
    ...
    enable_compliant_contact: bool = True
    """Whether to enable compliant contact materials."""
    ...
    # SDF tool configuration
    sdf_tool: Literal["trimesh", "pysdf", "physx"] = "physx"
    """Tool for signed distance field computation. Options: 'trimesh', 'pysdf', 'physx'."""

    # Indenter configuration for force field sensing
    indenter_actor_name: str = MISSING
    """Name of the indenter actor for SDF-based collision detection."""

    indenter_link_name: str = MISSING
    """Name of the indenter link for SDF-based collision detection."""
    ...
    use_acceleration_spring: bool = False
    """Whether to use acceleration spring for compliant dynamics."""
    ...
    camera_dist: float = 0.020342857142857145
    """Distance from elastomer tip to camera (in meters)."""

    tip_to_cam_euler: tuple[float, float, float] = (0.0, 0.0, 0.0)
    """Euler angles for camera orientation relative to tip (in radians)."""

    image_height: int = 320
    """Height of tactile images."""

    image_width: int = 240
    """Width of tactile images."""

    # Visualization
    visualizer_cfg: VisualizationMarkersCfg = CONTACT_SENSOR_MARKER_CFG.replace(prim_path="/Visuals/TactileSensor")
    ...
    visualize_tactile_points: bool = False
    """Whether to visualize tactile points for debugging."""
