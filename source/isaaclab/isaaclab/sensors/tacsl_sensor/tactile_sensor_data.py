...
"""Data class for the tactile sensor."""
...
class TactileSensorData:
    ...
    tactile_rgb: torch.Tensor | None = None
    """Tactile RGB images. Shape: (num_instances, height, width, 3)."""
    ...
    """Contact normal directions in world frame. Shape: (num_instances, num_tactile_points, 3)."""
